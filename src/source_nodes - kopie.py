...
def claim_matching(stateSource: AgentStateSource) -> Command[Literal["match_or_continue"]]:
    ...
    print(f"matching {stateSource.get("next_node")} en {stateSource.get("awaiting_user")}")
    if stateSource.get("next_node") is None:
...
def match_or_continue(stateSource: AgentStateSource) -> Command[Literal["get_source", "__end__"]]:
    ...
    if stateSource.get("next_node")=="match_or_continue" or stateSource.get("next_node") is None:
        print(f"hier match and continue{stateSource.get("next_node")} en {stateSource.get("awaiting_user")}")
        if stateSource.get("awaiting_user"):
            print("number 1")
...
def get_source(stateSource: AgentStateSource) -> Command[Literal["get_primary_source"]]:
    ...
    print(f"get_source {stateSource.get("next_node")}")

    if stateSource.get("next_node")=="get_source" or stateSource.get("next_node") is None:
...
def get_primary_source(stateSource: AgentStateSource) -> Command[Literal["research_claim","locate_primary_source"]]:
    ...
    print(f"get_primary_source {stateSource.get("next_node")}")
    if stateSource.get("next_node")=="get_primary_source" or stateSource.get("next_node") is None:
...
def locate_primary_source(stateSource: AgentStateSource) -> Command[Literal["select_primary_source"]]:
    ...
    print(f"locate primary_source {stateSource.get("next_node")}")
    if stateSource.get("next_node")=="locate_primary_source" or stateSource.get("next_node") is None:
...
def select_primary_source(stateSource: AgentStateSource) -> Command[Literal["research_claim"]]:
    ...
    print(f"select primary_source {stateSource.get("next_node")}")
    if stateSource.get("next_node")=="select_primary_source" or stateSource.get("next_node") is None:
...
def research_claim(stateSource: AgentStateSource) -> Command[Literal["__end__"]]:
    ...
    print(f"research {stateSource.get("next_node")}")
    if stateSource.get("next_node")=="research_claim" or stateSource.get("next_node") is None:
