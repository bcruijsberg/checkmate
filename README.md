...
Training and evaluation data were grounded in **real-world fact-checking claims** from the **FACTors project**, a large-scale dataset for studying the fact-checking ecosystem. This data was also used in the assistant for claim matching.
